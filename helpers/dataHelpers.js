import { groupBy, trimDate, getObjectKeys, getMostFrequent, } from '../utilities/dataUtils';
// /*
...
//   };
// }
export function createForecastArr(response) {
    const obj = [];
...
export function parseCurrentWeather(response, foreResponse) {
    return {
