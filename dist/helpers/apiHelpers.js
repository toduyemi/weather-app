...
export const iconPath = './static/assets/weather-icons-master/production/line/openweathermap/';
export const WEATHER_API_URL = 'https://api.openweathermap.org/data/';
export const GEO_CITIES_URL = 'https://wft-geo-db.p.rapidapi.com/v1/geo/cities/?sort=-population';
export const url = {
    weather(coord) {
